...
0
|| checktplrefresh('./template/default/forum/ajax.htm', './template/default/common/header_ajax.htm', 1522580529, '11', './data/template/10_11_forum_ajax.tpl.php', './template/test999_game_16080201', 'forum/ajax')
|| checktplrefresh('./template/default/forum/ajax.htm', './template/default/common/footer_ajax.htm', 1522580529, '11', './data/template/10_11_forum_ajax.tpl.php', './template/test999_game_16080201', 'forum/ajax')
;?>
<?php ob_end_clean();
ob_start();
@header("Expires: -1");
